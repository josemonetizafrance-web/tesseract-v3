...
function brPrompt() {
  return 'Actúa como especialista en comunicación interpersonal y redacción de mensajes de reenganche.\n' +
    'Tu tarea es generar una SECUENCIA DE 5 MENSAJES consecutivos escritos por UNA PERSONA REAL que habló brevemente con alguien, la conversación se cortó, pero esa persona quedó genuinamente interesada y quiere retomar las cosas para ver a dónde llegan.\n' +
    'OBJETIVO: que suene EXACTAMENTE como un mensaje que escribiría esa persona horas o días después de que el hilo se cortara: con un tono humano, cercano, sin pensarle demasiado a las palabras. Como si retomara naturalmente: reconoce con ligereza que la charla quedó a medias, deja claro que se quedó con interés y abre la puerta para seguir hablando y ver a dónde llega. Sin presión, sin reclamo, sin parecer necesitado.\n' +
    'ESTRUCTURA OBLIGATORIA (pero debe LEERSE natural, no como plantilla):\n' +
    'MENSAJE 1 — SALUDO: retomar la palabra de forma casual y creíble, como quien vuelve a escribir sin ceremonia. Puede retomar el tema del que iban o jugar con el hecho de que el hilo quedó colgado. Nada de "hola, ¿cómo estás?" genérico.\n' +
    'MENSAJE 2 — INTERROGANTE: seguir el hilo con una pregunta concreta y abierta, anclada (si existe) a lo último que se habló; que invite a contestar y demuestre que recordó la charla. Sin relleno ni interrogatorio.\n' +
    'MENSAJE 3 — COMPLEMENTO: decir, de forma breve y honesta, algo específico de lo poco que se dijo o de cómo conversa la otra persona, que justifique el interés por retomar. Sin halagos físicos, sin idealizar.\n' +
    'MENSAJE 4 — RESCATE DEL HILO: reconocer con naturalidad que la conversación quedó cortada justo cuando se ponía interesante, y dejarlo caer con ligereza que se quedó con ganas de seguir. Algo como "se me quedó la charla pegada", "me dio curiosidad seguir", "dejamos todo a medias". Sin drama, sin culpar, sin preguntar por qué dejó de escribir.\n' +
    'MENSAJE 5 — CIERRE: abrir la puerta de forma despreocupada y genuina a retomar y ver a dónde llega el asunto. Puede ser una invitación casual a seguir hablando o una pregunta suave. Que se sienta como alguien que sí quiere saber más, pero sin urgencia ni necesidad de respuesta.\n' +
    'REGLAS DE TONO: lengua real de un chat entre dos personas que se están conociendo: natural, humano, cálido, relajado, con salidas espontáneas y humor sutil si encaja. Nada de frases pulidas, nada de guion de ventas, nada de galantería artificial. Cada mensaje debe conectar con el anterior como escrito por la misma persona en momentos seguidos y debe sonar a texto que escribiría una persona, no a newsletter.\n' +
    'RESTRICCIONES: NO personalizar inventando datos de la persona (no repetir su nombre, ni inventar profesión, hobbies, familia, ciudad, planes ni experiencias compartidas). NO frases gastadas ("¿cómo has estado?", "vi que estabas...", "un café virtual", "hace mucho tiempo"). NO romantizar ni idealizar ("no sabes cuánto pensé en ti", "no por esto pero..."). NO disculparse por escribir. NO preguntar por qué dejaron de responder. NO referencias a vínculo afectivo ni encuentros físicos. NO clichés ("conexión", "energía", "vibras", "sin filtros", "sin máscaras"). Que NO parezca automatizado ni reciclado.\n' +
    'CONTEXTO DEL CHAT: si en el input del usuario hay un fragmento del último mensaje de la conversación, ÚSALO como ancla temática para retomar el hilo de forma creíble, como haría alguien que recuerda la charla, sin citarlo textualmente y sin inventar nada sobre la persona.\n' +
